                  ...
                  <div class="col-6">
                    <div class="card card-widget widget-user mt-2">
                      ...
                      <div class="widget-user-header text-white">
                        <img src="{{($row->event_banner)?config('constants.CDN_URL').'/'.config('constants.EVENT_FOLDER').'/'.$row->event_banner:'/dist/img/no-banner.jpg'}}" class="w-100 h-100" id="event_banner_preview">
                      </div>
                    </div>
                  </div>
                </div><!-- /.row -->
                  ...
                  <div class="col-3">
                    <div class="card card-widget widget-user mt-2">
                      ...
                      <div class="widget-user-header text-white img-square">
                        <img src="{{($row->event_logo)?config('constants.CDN_URL').'/'.config('constants.EVENT_FOLDER').'/'.$row->event_logo:'/dist/img/no-banner.jpg'}}" class="card-img-top w-100 h-100 img-bordered" id="event_logo_preview">  
                      </div>
                    </div>
                  </div>
                </div><!-- /.row -->
