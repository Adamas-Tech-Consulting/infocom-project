              ...
              <div class="col-5">
                <div class="card card-widget widget-user mt-2">
                  ...
                  <div class="card-body widget-user-header logo-image">
                    <img src="{{($row->image)?config('constants.CDN_URL').'/'.config('constants.SPEAKERS_FOLDER').'/'.$row->image:'/dist/img/no-banner.jpg'}}" class="w-100 h-100 img-bordered" id="image_preview">
                  </div>
