              ...
              <div class="row">
                ...
                <div class="col-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('schedule_group') is-invalid @enderror" id="schedule_group" name="schedule_group" placeholder="{{ __('admin.enter') }} {{ __('admin.schedule') }} {{ __('admin.group') }}">
                  </div>
                </div>
                <div class="col-4">
                  <div class="form-group">
