  ...
  <div class="row">
    <div class="col-12">
      <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link" id="tab2" href="{{route('users_update_password',$row->id)}}" role="tab" aria-controls="tab2" aria-selected="false">{{ __('admin.update_password') }}</a>
        </li>
      </ul>
            ...
            <div class="row">
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="{{ __('admin.enter') }} {{ __('admin.name') }}" value="{{$row->name}}">
                </div>
              </div>
              <div class="col-6">
                <div class="form-group">
