      ...
      <div class="card card-warning card-outline direct-chat-warning">
        ...
        <div class="card-body">
          <table id="list_table" class="table table-bordered table-striped w-100">
            ...
            <tr>
              <td>{{$key+1}}</td>
              <td><img class="conference-logo img-circle img-bordered" src="{{config('constants.CDN_URL')}}/{{config('constants.CIO_FOLDER')}}/{{ $row->image}}"/></td>
              <td>{{$row->first_name}} {{$row->last_name}}({{$row->designation}})</td>
