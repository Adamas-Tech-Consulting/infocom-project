              ...
              <div class="row">
                ...
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" placeholder="{{ __('admin.enter') }} {{ __('admin.conference') }} {{ __('admin.name') }}">
                  </div>
                </div>
              </div><!-- /.row -->
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('conference_venue') is-invalid @enderror" id="conference_venue" name="conference_venue" placeholder="{{ __('admin.enter') }} {{ __('admin.conference') }} {{ __('admin.venue') }}">
                  </div>
                </div>
                <div class="col-4">
                  <div class="form-group">
                    <label for="title">{{ __('admin.conference') }} {{ __('admin.theme') }} <span class="text-red">*</span></label>
                    <input type="text" class="form-control @error('conference_theme') is-invalid @enderror" id="conference_theme" name="conference_theme" placeholder="{{ __('admin.enter') }} {{ __('admin.conference') }} {{ __('admin.theme') }}">
                  </div>
                </div>
              </div><!-- /.row -->
              <div class="row">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <textarea id="conference_description" name="conference_description" class="summernote @error('conference_description') is-invalid @enderror"></textarea>
                  </div>
                </div>
              </div><!-- /.row -->
              <div class="row">
                ...
                <div class="col-6">
                  <div class="card card-widget widget-user mt-2">
                    ...
                    <div class="widget-user-header text-white">
                      <img src="/dist/img/no-banner.jpg" class="w-100 h-100" id="conference_banner_preview">
                    </div>
                  </div>
                </div>
              </div><!-- /.row -->
                ...
                <div class="col-3">
                  <div class="card card-widget widget-user mt-2">
                    ...
                    <div class="widget-user-header text-white img-square">
                      <img src="/dist/img/no-banner.jpg" class="card-img-top w-100 h-100 img-bordered" id="conference_logo_preview">  
                    </div>
                  </div>
                </div>
              </div><!-- /.row -->
