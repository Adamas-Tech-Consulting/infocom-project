            ...
            <div class="row">
              ...
              <div class="col-4">
                <div class="form-group">
                  ...
                  <select class="form-control select2bs4 @error('source_group') is-invalid @enderror" name="source_group" style="width: 100%;">
                    ...
                    <option value="{{$contacts_group->id}}" {{($contacts_group->id==$row->source_group)?'selected':''}}>{{$contacts_group->name}}</option>
                    @endforeach
                  </select>
                </div>
              </div>
              <div class="col-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('mail_subject') is-invalid @enderror" id="mail_subject" name="mail_subject" placeholder="{{ __('admin.enter') }} {{ __('admin.mail_subject') }}" value="{{$row->mail_subject}}">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                  ...
                  <textarea id="mail_body" name="mail_body" class="summernote-large @error('mail_body') is-invalid @enderror">{{$row->mail_body}}</textarea>
                </div>
              </div>
            </div><!-- /.row -->
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                  ...
                  <textarea id="mail_signature" name="mail_signature" class="summernote-large @error('mail_signature') is-invalid @enderror">{{$row->mail_signature}}</textarea>
                </div>
              </div>
            </div><!-- /.row -->
          </div>
