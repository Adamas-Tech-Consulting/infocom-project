...
class FrontendController extends Controller
{
    ...
    protected function send_welcome_mail($order_id)
    {
        ...
        $mail_data = [
            ...
            'attendance_type' => ($row_event->registration_type=='P' && !$rel_data->rt_request) ? $event_price->name_with_price : ( !empty($event_price->name_without_price) ? $event_price->name_without_price : ''),
            'order_id' => $order_id,
